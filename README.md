...
> **מאמר מקורי:**
> Goodfellow, I. J., Mirza, M., Xiao, D., Courville, A., & Bengio, Y. (2015).
...
*   [**תוכניות עבודה (AI Plans)**](docs/ai_plans.md) – מסמכי התכנון הגולמיים שנוצרו בשלב התכנון הראשוני ושימשו לבניית מבנה הפרויקט.
...
ההרצה מייצרת גרפים שנועדו להתכתב עם המגמות העיקריות שנצפו במחקר המקורי:

...
> **Bonus:** This ablation study was not part of the original Goodfellow et al. (2015) paper. It is submitted as a bonus improvement under the criterion **"Proposing an alternative approach to data analysis"** — instead of comparing only final error values, we isolate the contribution of each component (Dropout rate, Weight Decay) through controlled single-variable experiments.
